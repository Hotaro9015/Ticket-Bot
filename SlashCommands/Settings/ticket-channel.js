...
module.exports = {
    ...
    run: async (client, interaction, args) => {
      ...
      .setTitle(`<:Ticket:990858478128083024> Open a Ticket`)
      ...
      .addComponents([
        ...
        .setLabel(label)
        .setStyle(`PRIMARY`)
        .setEmoji(`<:Ticket:990858478128083024>`)
      ...
      .addField(`<:Channel:983313352384188416> Ticket Channel:`, `**${channel} (${channel.id})**`)
      .addField(`<:Channel:983313352384188416> Ticket Category:`, `**${category || `_\` None Set, Using Default \`_`}**`)
